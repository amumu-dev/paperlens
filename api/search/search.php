...
$result = mysql_query("select * from sphinx  where query='@(title,name,abstract) \"" . $query . "\";mode=extended;sort=expr:@weight*(1 + citations/10) /(2012 - year);limit=".$topN. ";index=idx1';");
if (!$result) {
