...
<html>
	<head>
		...
		<style type="text/css">
			...
			.like{width:3.5%; margin-right:1.5%; float:left;background:#000;vertical-align:bottom;height:18px;line-height:18px;cursor:pointer; font-size:12px;text-align:center;color:#FFF;}
